...
| --- | --- | --- |
| https://github.com/uber/RIBs | RIBs requires router/interactor/component boundaries; the pinned local library tests verify interactor behavior, not Uber-scale payoff. | `examples/ribs/` |
...
> not a verified runnable application.
