...
//
//   xcodebuild build -scheme CoordinatorExample -destination 'generic/platform=iOS'
//   xcodebuild test  -scheme CoordinatorExample -destination 'platform=iOS Simulator,name=iPhone 17 Pro'
//
...
let package = Package(
    ...
    platforms: [.iOS(.v17)],
    products: [
        .library(name: "CoordinatorExample", targets: ["CoordinatorExample"])
    ],
    targets: [
        .target(
            name: "CoordinatorExample",
        ...
        .testTarget(
            name: "CoordinatorExampleTests",
            dependencies: ["CoordinatorExample"],
            path: "Tests"
        )
    ]
)
